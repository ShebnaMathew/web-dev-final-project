        ...
        <div>
            <div className="row justify-content-md-center text-black mt-4 ms-2">
                <div className="col-8 bg-dark text-black fontFamily pt-2 pb-3 wd-round-corners wd-background wd-z-index">
                    <h1 className="d-flex text-black">Commentify Privacy Policy</h1>
                    ...
                    <h5>1. About this Policy</h5>
                    <div>
                        <p>This Policy describes how we process your personal data at Commentify Inc.</p>
                    ...
                    <h5>2. Your personal data rights and controls</h5>
                    <div>
                        <p>Privacy laws, including the General Data Protection Regulation ("GDPR"), give rights to individuals over their personal data.
                        ...
                        <table className="table table-bordered text-black">
                            ...
                            <tr>
                                ...
                                <td><p>Object to us processing your personal data at any time, on grounds relating to your particular situation</p>

                                    <p>Object to your personal data being processed for direct marketing purposes</p></td>
                            </tr>
                            <tr>
                        ...
                        <div>
                            <p>How to exercise your rights with Commentify</p>
                    ...
                    <h5>3. Personal data we collect about you</h5>
                    <div>
                        ...
                        <table className="table table-bordered text-black">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <p>Personal data that we need to create your Commentify account and enables you to use our service.</p>
                                        <p>The type of data collected may include your:</p>
                                        ...
                                        <p>We receive this data from you e.g. from the sign up form or account page.</p>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
                    ...
                    <h5>4. Our purpose for using your personal data</h5>
                    <div className="pb-2">
                        <p>Our purpose for processing your personal data is:</p>
                        <ul className="pt-1">
                    ...
                    <h5>5. Sharing your personal data</h5>
                    <div className="pb-2">
                        <div>
                            <p>This section sets out the categories of recipients of the personal data collected or generated through your use of the Commentify Service.</p>

                            <p className="fw-bold">Publicly available information</p>

                            <p>The following personal data will always be publicly available on the Commentify Service:</p>
                            <ul className="pt-1">
                        ...
                        <h5>6. Data retention and deletion</h5>
                        <div>
                            <p className="fw-bold">Retention</p>

                            <p>We keep your personal data only as long as necessary to provide you with the Commentify Service and for Commentify's legitimate and essential business purposes, such as:</p>
                            ...
                            <p>If you close or request that we close your account, we'll delete or anonymise your personal data so it no longer identifies you.</p>
                        </div>

                        <a name="embedding-data-safety"></a>
                        <h5>7. Keeping your personal data safe</h5>
                        <div>
                            <p>We're committed to protecting our users' personal data. We implement appropriate technical and organisational measures to help protect the security of your personal data. However, be aware that no system is ever completely secure.</p>

                            <p>We have implemented various safeguards including pseudonymisation, encryption, access, and retention policies to guard against unauthorised access and unnecessary retention of personal data in our systems.</p>
                        ...
                        <h5>8. Children</h5>
                        <div>
                            <p>The Commentify Service has a minimum "Age Limit". The Commentify Service is not directed to children whose age:</p>
                            ...
                            <p>We do not knowingly collect personal data from children under the applicable Age Limit. If you're under the Age Limit, please do not use the Commentify Service, and do not provide any personal data to us. </p>

                            <p>If we learn that we've collected the personal data of a child under the applicable Age Limit, we'll take reasonable steps to delete the personal data. This may require us to delete the Commentify account for that child.</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p>When we make material changes to this Policy, we'll provide you with prominent notice as appropriate under the circumstances. For example, we may display a prominent notice within the Commentify Service or send you an email or device notification.</p>
                        </div>
