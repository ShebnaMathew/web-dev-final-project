            ...
            <div class="row justify-content-center m-0 wd-details-container-children">
                ...
                <div class="col col-lg-6 wd-background-banner wd-details-container-children">
                    ...
                    <div class="row justify-content-md-center mb-5">
                        ...
                        <p className="row justify-content-center mt-1"><a href={post.external_urls.spotify} target="_blank" className="row text-center justify-content-center mt-3 wd-detail-text-deco-none wd-detail-bold-font">{post.name}</a></p>
                ...
                <div className="col col-lg-5 wd-detail-right-max wd-detail-parent wd-zero-margin wd-details-container-children wd-details-container-children-overflow">
                    <p className="mt-4">
                        <span className="">
                            {/* get likes from db */}
