...
const PlaylistTrackList = ({playlistId, playlistName}) => {
    ...
    return(
        <div className="row justify-content-md-center ms-0">
            <div className="list-group list-group-flush my-3 wd-detail-parent wd-comment-height wd-detail-comment-overflow pe-0">
