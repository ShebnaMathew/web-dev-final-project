...
const EpisodeList = () => {
    ...
    return(
        <div className="row justify-content-md-center wd-track-height ms-0">
            <div className="list-group list-group-flush my-3 pe-0 wd-playlist-inner-track-height wd-detail-comment-overflow">
